...
const CyclingClubs = () => {
  ...
  useEffect(() => {
    ...
    const RANGE = 'CyclingClubs!A1:N22';
  ...
  const filteredClubs = clubs.filter((club: CyclingClub) => {
...
<div className="social-filter">
  <label>
  <strong>Social</strong> (regular socializing after rides):
    <input 
      type="checkbox" 
      checked={isSocial} 
...
<div className="very-social-filter">
  <label>
  <strong>Very social</strong> (the social is more important than the ride):
    <input 
      type="checkbox" 
